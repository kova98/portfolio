...
const Home = () => {
    return (
        <div className="flex flex-col min-h-screen justify-center items-center p-4 xl:scale-100 lg:scale-100">
            <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-10 max-w-4xl w-full">
                <div className="flex flex-col items-center lg:items-start lg:w-2/5 mb-10 lg:mb-0">
                    ...
                    <p className="pb-4 text-center lg:text-left mt-10 text-xl">
                    ...
                    <ContactButton className="mt-10 ml-4 scale-125"/>
                </div>
                <div className="flex flex-col items-center lg:items-center lg:w-2/5">
                    <div className="w-full relative pt-[100%]">
                        <Image
                            ...
                            objectFit="cover"
                            fill
                            className="w-full h-full top-0 left-0 object-cover rounded-full p-14"
                        />
                    </div>
